# ESTUDO DE CASO 1 - DADOS COVID 19 ANO 2020 E 1º SEM 2021

#Para este estudo de caso vamos aplicar SQL para analisar dados reais sobre a pandemia 
#do Covid-19. Faremos análise de estatísticas, agregações, relacionamentos e ainda análise de 
#dados ao longo do tempo. Por fim, apresentaremos o resultado do nosso trabalho de análise
...
# Conecte no MySQL via linha de comando (Windows) - CMD
...
# Carrega os dados
LOAD DATA LOCAL INFILE '/Users/Usuario/Documents/CURSOS/SQL/cap07/EstudoCaso1/covid_mortes.csv' INTO TABLE `cap07`.`covid_mortes` CHARACTER SET UTF8
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;

LOAD DATA LOCAL INFILE '/Users/Usuario/Documents/CURSOS/SQL/cap07/EstudoCaso1/Cap07/EstudoCaso1/covid_vacinacao.csv' INTO TABLE `cap07`.`covid_vacinacao` CHARACTER SET UTF8
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
