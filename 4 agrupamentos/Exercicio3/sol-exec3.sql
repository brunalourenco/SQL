...
# Carrega os dados
LOAD DATA LOCAL INFILE 'C:/Users/Usuario/Documents/CURSOS/DATA SCIENCE/SQL/cap05/Exercicio3/Athletes.csv' 
INTO TABLE `exec3`.`TB_ATLETAS`
CHARACTER SET UTF8 FIELDS 
TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n'
IGNORE 1 LINES;

 LOAD DATA LOCAL INFILE 'C:/Users/Usuario/Documents/CURSOS/DATA SCIENCE/SQL/cap05/Exercicio3/Coaches.csv'
 INTO TABLE `exec3`.`TB_COACHES` CHARACTER SET UTF8 FIELDS
 TERMINATED BY',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n'
 IGNORE 1 LINES;

 LOAD DATA LOCAL INFILE 'C:/Users/Usuario/Documents/CURSOS/DATA SCIENCE/SQL/cap05/Exercicio3/EntriesGender.csv'
 INTO TABLE `exec3`.`TB_ENTRIESGENDER` CHARACTER SET UTF8
 FIELDS TERMINATED BY',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n'
 IGNORE 1 LINES;

 LOAD DATA LOCAL INFILE 'C:/Users/Usuario/Documents/CURSOS/DATA SCIENCE/SQL/cap05/Exercicio3/Teams.csv'
 INTO TABLE `exec3`.`TB_TEAMS` CHARACTER SET UTF8
 FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n'
 IGNORE 1 LINES;
